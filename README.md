...
- **Aturan Bisnis**:
  ...
  - Sistem otomatis mencatat riwayat pembayaran tunai (_cash transaction_) di database saat membership baru berhasil dibuat.
...
- **Endpoint Swagger UI**: Saat server dijalankan, dokumentasi interaktif tersedia di `http://localhost:<PORT>/api-docs` (contoh: `http://localhost:5000/api-docs` jika `PORT=5000`).
